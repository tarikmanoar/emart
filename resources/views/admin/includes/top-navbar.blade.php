            ...
            <div class="navbar-header">
                <a href="db-default.html" class="navbar-brand">
                    <div class="brand-image brand-big">
                        <img src="{{asset('admin/img/logo-big-2.png')}}" alt="logo" class="logo-big">
                    </div>
                    <div class="brand-image brand-small">
                        <img src="{{asset('admin/img/logo-2.png')}}" alt="logo" class="logo-small">
                    </div>
                </a>
                <!-- Toggle Button -->
            ...
            <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center pull-right">
                ...
                <li class="nav-item dropdown"><a id="notifications" rel="nofollow" data-target="#" href="#"
                    ...
                    <ul aria-labelledby="notifications" class="dropdown-menu notification">
                        ...
                        <li>
                            <a rel="nofollow" href="#" class="dropdown-item all-notifications text-center">View All
                                Notifications</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown"><a id="user" rel="nofollow" data-target="#" href="#"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><img
                            src="{{asset('admin/img/avatar/avatar-01.jpg')}}" alt="..."
                            class="avatar rounded-circle"></a>
                    <ul aria-labelledby="user" class="user-size dropdown-menu">
                        <li class="welcome">
                            <a href="#" class="edit-profil"><i class="la la-gear"></i></a>
                            <img src="{{asset('admin/img/avatar/avatar-01.jpg')}}" alt="..." class="rounded-circle">
                        </li>
                        <li>
