        ...
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-6 no-padding">
                <div class="clearfix payment-methods">
                    <ul>
                        <><img src="{{asset('frontend/assets/images/payments/1.png" alt=""></')}}li>
                        <><img src="{{asset('frontend/assets/images/payments/2.png" alt=""></')}}li>
                        <><img src="{{asset('frontend/assets/images/payments/3.png" alt=""></')}}li>
                        <><img src="{{asset('frontend/assets/images/payments/4.png" alt=""></')}}li>
                        <><img src="{{asset('frontend/assets/images/payments/5.png" alt=""></')}}li>
                    </ul>
                </div><!-- /.payment-methods -->
            </div>
        </div>
...
<!-- ============================================================= FOOTER : END============================================================= -->
	...
	< src="{{asset('frontend/assets/js/jquery-1.11.1.min.js"></')}}script>

	< src="{{asset('frontend/assets/js/bootstrap.min.js"></')}}script>

	< src="{{asset('frontend/assets/js/bootstrap-hover-dropdown.min.js"></')}}script>
	< src="{{asset('frontend/assets/js/owl.carousel.min.js"></')}}script>

	< src="{{asset('frontend/assets/js/echo.min.js"></')}}script>
	< src="{{asset('frontend/assets/js/jquery.easing-1.3.min.js"></')}}script>
	< src="{{asset('frontend/assets/js/bootstrap-slider.min.js"></')}}script>
    < src="{{asset('frontend/assets/js/jquery.rateit.min.js"></')}}script>
    < type="text/javascript" src="{{asset('frontend/assets/js/lightbox.min.js"></')}}script>
    < src="{{asset('frontend/assets/js/bootstrap-select.min.js"></')}}script>
    < src="{{asset('frontend/assets/js/wow.min.js"></')}}script>
	< src="{{asset('frontend/assets/js/scripts.js"></')}}script>
